...
function pullRightAction() {
    if (trimStart > 0) {
        ...
        var newLi = jQuery('<li>').append(jQuery('<img/>', {src: 'loban-data/thuoc522' + '-' + qStr + '.png'}))
            .append(jQuery('<img/>', {src: 'loban-data/thuoc429' + '-' + qStr + '.png'}))
            .append(jQuery('<img/>', {src: 'loban-data/thuoc388' + '-' + qStr + '.png'}));
